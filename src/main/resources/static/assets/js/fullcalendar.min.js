...
!(function (a) {
    ...
    function ea(c, d, e) {
        ...
        return (
            b.isMoment(j)
                ...
                : ((f = !1),
                  (g = !1),
                  k ? (Wa.test(j) ? ((j += "-01"), (c = [j]), (f = !0), (g = !0)) : (h = Xa.exec(j)) && ((f = !h[5]), (g = !0))) : a.isArray(j) && (g = !0),
    ...
    function Ga(c, d) {
        ...
        function i(b) {
            ca++,
                ...
                W && ((Z = W.massageCurrentDate(Z)), (W.displaying && Z.isWithin(W.intervalStart, W.intervalEnd)) || (h() && (H(), W.display(Z), I(), u(), v(), q()))),
                I(),
                ca--;
        }
        function j(a) {
        ...
        (P._fullCalendar_weekCalc = (function (a) {
            ...
            (N.moment = function () {
                var a;
                return (
                    "local" === O.timezone ? ((a = Ma.moment.apply(null, arguments)), a.hasTime() && a.local()) : (a = "UTC" === O.timezone ? Ma.moment.utc.apply(null, arguments) : Ma.moment.parseZone.apply(null, arguments)),
    ...
    function Ka(c) {
        ...
        function v(a) {
            null == a.allDay && (a.allDay = !(a.start.hasTime() || (a.end && a.end.hasTime()))),
                a.allDay ? (a.start.stripTime(), a.end && a.end.stripTime()) : (a.start.hasTime() || (a.start = L.rezoneDate(a.start)), a.end && !a.end.hasTime() && (a.end = L.rezoneDate(a.end)));
        }
        function w(b) {
            var c;
        ...
        function y(b, c, d) {
            ...
            return (
                ...
                u(c),
                (f = { start: b._start.clone(), end: b._end ? b._end.clone() : L.getDefaultEventEnd(b._allDay, b._start), allDay: c.allDay }),
                u(f),
        ...
        (Ya.isSame = function (a, b) {
            ...
            return this._fullCalendar
                ? b
                    ...
                    : ((a = Ma.moment.parseZone(a)), Za.isSame.call(this, a) && Boolean(this._ambigTime) === Boolean(a._ambigTime) && Boolean(this._ambigZone) === Boolean(a._ambigZone))
            ...
            return (
                g.hasTime() === h.hasTime()
                    ? ((d = this.diffDates(h, g)),
                      c.allDay && N(d) ? ((e = { start: c.start.clone(), end: f.getEventEnd(c), allDay: !1 }), f.normalizeEventRangeTimes(e)) : (e = { start: c.start.clone(), end: c.end ? c.end.clone() : null, allDay: c.allDay }),
                      e.start.add(d),
                      e.end && e.end.add(d))
        ...
        rangeToSegs: function (a) {
            ...
            for (a = this.view.computeDayRange(a), b = this.dateToCellOffset(a.start), c = this.dateToCellOffset(a.end.subtract(1, "days")), d = 0; m > d; d++)
                (e = d * n),
                    ...
                    (i = Math.ceil(i)),
                    (j = Math.floor(j)),
                    j >= i && ((g = i === b), (h = j === c), (i -= e), (j -= e), (k = { row: d, isStart: g, isEnd: h }), l ? ((k.leftCol = n - j - 1), (k.rightCol = n - i - 1)) : ((k.leftCol = i), (k.rightCol = j)), o.push(k));
            return o;
        },
    ...
    lb.mixin({
        ...
        computeSlotSegCoords: function (a, b, c) {
            ...
            if (void 0 === a.forwardCoord)
                for (
                    e.length ? (this.sortForwardSlotSegs(e), this.computeSlotSegCoords(e[0], b + 1, c), (a.forwardCoord = e[0].backwardCoord)) : (a.forwardCoord = 1), a.backwardCoord = a.forwardCoord - (a.forwardCoord - c) / (b + 1), d = 0;
                    d < e.length;
                    d++
                )
    ...
    var mb = (Ma.View = ra.extend({
        ...
        nb = (Ma.Calendar = ra.extend({
            ...
            buildSelectRange: function (a, b) {
                return (a = this.moment(a)), (b = b ? this.moment(b) : a.hasTime() ? a.clone().add(this.defaultTimedEventDuration) : a.clone().add(this.defaultAllDc - ayEventDuration)), { start: a, end: b };
            },
        }));
    nb.mixin(bb),
        (nb.defaults = {
    ...
    var wb = mb.extend({
            ...
            headIntroHtml: function () {
                ...
                return this.opt("weekNumbers")
                    ? ((a = this.timeGrid.getCell(0).start), (b = a.format(this.opt("smallWeekFormat"))), '<th class="fc-axis fc-week-number ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + "><span>" + Y(b) + "</span></th>")
            ...
            setHeight: function (a, b) {
                ...
                null === this.bottomRuleHeight && (this.bottomRuleHeight = this.bottomRuleEl.outerHeight()),
                    ...
                    this.dayGrid && (this.dayGrid.removeSegPopover(), (c = this.opt("eventLimit")), c && "number" != typeof c && (c = xb), c && this.dayGrid.limitRows(c)),
                    b ||
    ...
    return (
        (Na.agenda = { class: wb, defaults: { allDaySlot: !0, allDayText: "all-day", slotDuration: "00:30:00", minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0 } }),
